                ...
                <section class="login_user">
                    ...
                    if(LOGIN === true)
                    {
                        if(empty($_SESSION['user'])) {
                            ?>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-10 offset-md-2 col-lg-10 offset-lg-2">
                                    <div class="loginandregister imdisplayed">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="header_new_user">
                                                    <h3>
                                                        Nuevo Usuario
                                                    </h3>
                                                    <p>
                                                        Tollina ojete moreno one more time chachachá nostrud coconut asobinao cobete sed chotera estoy fatal de lo mío, hueles avinagrado.
                                                    </p>
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-6 offset-md-6 col-lg-6 offset-lg-6">
                                                            <a href="#" class="btn btn-standard btn-block">
                                                                Registrarse
                                                            </a>
                                                        </div>
                                                    </div>
