const urlObtenerUsuarios =
  "http://localhost/appdist/CRUD-MySQL-PHP-HTML-CSS-JavaScript-main/api/obtenerUsuarios.php";
const urlAgregarUsuario =
  "http://localhost/appdist/CRUD-MySQL-PHP-HTML-CSS-JavaScript-main/api/agregarUsuario.php";
const urlEditarUsuario =
  "http://localhost/appdist/CRUD-MySQL-PHP-HTML-CSS-JavaScript-main/api/editarUsuario.php";
const urlBorrarUsuario =
  "http://localhost/appdist/CRUD-MySQL-PHP-HTML-CSS-JavaScript-main/api/borrarUsuario.php";
